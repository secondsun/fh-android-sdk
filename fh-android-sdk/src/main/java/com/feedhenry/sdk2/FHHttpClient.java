...
public class FHHttpClient {
    ...
    public void put(
            ...
            boolean pUseSync)
            throws Exception {
        put(pUrl, pHeaders, new org.json.JSONObject(pParams.toString()), pCallback, pUseSync);
    }
    ...
    public void get(
            ...
            boolean pUseSync)
            throws Exception {
        get(pUrl, pHeaders, new org.json.JSONObject(pParams.toString()), pCallback, pUseSync);
    }
    ...
    public void post(
            ...
            boolean pUseSync)
            throws Exception {
        post(pUrl, pHeaders, new org.json.JSONObject(pParams.toString()), pCallback, pUseSync);
    }
    ...
    public void delete(
            ...
            boolean pUseSync)
            throws Exception {
        org.json.JSONObject newParams = new org.json.JSONObject(pParams.toString());
    ...
    private RequestParams convertToRequestParams(org.json.JSONObject pIn) throws JSONException {
        ...
        public void onSuccess(int pStatusCode, Header[] pHeaders, org.json.JSONObject pRes) {
            ...
            if (callback != null) {
                try {
                    ...
                    callback.fail(new FHResponse((org.json.JSONObject) null, null, ex, ex.getMessage()));
                }
            }
        }
            ...
            if (callback != null) {
                try {
                    FHResponse fhres = new FHResponse(
                            new org.json.JSONObject(errorResponse),
                            null,
                            pError,
                            errorResponse);
                    callback.fail(fhres);
        ...
        public void onFailure(int pStatusCode, Header[] pHeaders, Throwable pError, org.json.JSONArray pErrorResponse) {
            ...
            if (callback != null) {
                try {
                    FHResponse fhres = new FHResponse(
                            null,
                            new org.json.JSONArray(pErrorResponse.toString()),
                            pError,
     ...
     * 10 seconds.
     *
     * @param milliseconds the connect/socket timeout in milliseconds, at least
     * 1 second
     */
